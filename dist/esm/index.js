...
function _init$3() {
  _init$3 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    var _yield$import, MagicConnector;
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            _yield$import = _context.sent;
            MagicConnector = _yield$import.MagicConnector;
            return _context.abrupt("return", {
              web3ReactConnector: function web3ReactConnector(_ref) {
                var chainId = _ref.chainId,
                    apiKey = _ref.apiKey,
                ...
                if (!email) {
                  throw new ConnectorConfigError('The Magic connector requires email to be set.');
                }
...
function getConnectors(initsOrConfigs) {
  ...
  var connectors = {
    ...
    magic: [init$3, null],
    portis: [init$4, null],
    provided: [init$5, null],
    torus: [init$6, null],
    walletconnect: [init$7, null],
    walletlink: [init$8, null]
  };
